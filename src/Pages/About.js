        ...
        <div className="about__quality">
          ...
          <div className="quality__container">
            <div className="about__quality-content">
              <h3>Time</h3>
              <p>
                We provide our services with the least of time.Delivery is done
                immediately after cleaning the laundries.Order anything and we
                will be with you at any
              </p>
            </div>
            <div className="about__quality-content">
              <h3>Staff</h3>
              <p>
                We have highly trained staff and professionals who are willing
                to do any work for you. It would be done in the best way
                possible
              </p>
            </div>
            <div className="about__quality-content">
              <h3>Our platforms</h3>
              <p>
                You can choose your services from our app or the website.Choose
                items from our price list or skip ahead with "Instant Order" and
                we'll bring an empty laundry bag for you to fill up.
              </p>
            </div>
            <div className="about__quality-content">
              <h3>Stuck??</h3>
              <p>
                Feel free to send us Email or call Us. We will be there to
                assist you in every way possible.Just sit and enjoy while we
                simplify your work
              </p>
            </div>
          </div>
        ...
        <div className="about__team">
          ...
          <div className="about__team-content">
            <Staff
              ...
              name="John Doe"
              description="A staff with the best quality who is willing to do anything for the company.We are glad to have such a person in our team . We are blessed"
            />
            <Staff
              image="../images/team.jpg"
              name="Jane Doe"
